...
<div id="wrap">
  ...
  <div id="side">
    ...
    ${m.primaryLanguages?.length ? `<div class="note">Primary structure: ${escapeHtml(m.primaryLanguages.slice(0, 4).join(', '))}<br>${escapeHtml(Object.entries(m.languageStats || {}).map(([lang, s]) => `${lang}: ${s.files} files / ${s.declarations} declarations / ${s.internalEdges} internal edges`).join(' · '))}</div>` : ''}
